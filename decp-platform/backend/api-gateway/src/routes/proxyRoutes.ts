...
// CORS preflight handler for /api/v1/auth - returns CORS headers without proxying
router.options('/api/v1/auth/register', (_req, res) => {
  res.status(204).end();
});
router.options('/api/v1/auth/login', (_req, res) => {
  res.status(204).end();
});
router.options('/api/v1/auth/refresh', (_req, res) => {
  res.status(204).end();
});
router.options('/api/v1/auth/logout', (_req, res) => {
  res.status(204).end();
});
router.options('/api/v1/auth/me', (_req, res) => {
  res.status(204).end();
});
router.options('/api/v1/auth/verify-email', (_req, res) => {
  res.status(204).end();
});
router.options('/api/v1/auth/forgot-password', (_req, res) => {
  res.status(204).end();
});
router.options('/api/v1/auth/reset-password', (_req, res) => {
  res.status(204).end();
});
...
router.get('/api/v1/users/suggested', authMiddleware, createProxyHandler(config.services.user, 'users'));
...
// CORS preflight handlers for feed service
router.options('/api/v1/posts/feed', (_req, res) => res.status(204).end());
router.options('/api/v1/posts/bookmarks/me', (_req, res) => res.status(204).end());
router.options('/api/v1/posts/upload', (_req, res) => res.status(204).end());
router.options('/api/v1/posts', (_req, res) => res.status(204).end());
router.options('/api/v1/posts/:postId', (_req, res) => res.status(204).end());
router.options('/api/v1/feed', (_req, res) => res.status(204).end());
...
// CORS preflight handlers for jobs service
router.options('/api/v1/jobs/health', (_req, res) => res.status(204).end());
router.options('/api/v1/jobs/applications', (_req, res) => res.status(204).end());
router.options('/api/v1/jobs', (_req, res) => res.status(204).end());
router.options('/api/v1/jobs/:jobId', (_req, res) => res.status(204).end());
...
// CORS preflight handlers for events service
router.options('/api/v1/events/health', (_req, res) => res.status(204).end());
router.options('/api/v1/events/my-rsvps', (_req, res) => res.status(204).end());
router.options('/api/v1/events', (_req, res) => res.status(204).end());
router.options('/api/v1/events/:eventId', (_req, res) => res.status(204).end());
...
// CORS preflight handlers for research service
router.options('/api/v1/research/health', (_req, res) => res.status(204).end());
router.options('/api/v1/research', (_req, res) => res.status(204).end());
router.options('/api/v1/research/:researchId', (_req, res) => res.status(204).end());
...
// CORS preflight handlers for messaging service
router.options('/api/v1/messaging/health', (_req, res) => res.status(204).end());
router.options('/api/v1/conversations', (_req, res) => res.status(204).end());
router.options('/api/v1/conversations/:conversationId', (_req, res) => res.status(204).end());
...
// CORS preflight handlers for notification service
router.options('/api/v1/notifications/health', (_req, res) => res.status(204).end());
router.options('/api/v1/notifications/read-all', (_req, res) => res.status(204).end());
router.options('/api/v1/notifications/push/subscribe', (_req, res) => res.status(204).end());
router.options('/api/v1/notifications/push/unsubscribe', (_req, res) => res.status(204).end());
router.options('/api/v1/notifications', (_req, res) => res.status(204).end());
router.options('/api/v1/notifications/:notificationId', (_req, res) => res.status(204).end());
...
// CORS preflight handlers for analytics service
router.options('/api/v1/analytics/health', (_req, res) => res.status(204).end());
router.options('/api/v1/analytics/dashboard', (_req, res) => res.status(204).end());
router.options('/api/v1/analytics/popular', (_req, res) => res.status(204).end());
router.options('/api/v1/analytics/track', (_req, res) => res.status(204).end());
router.options('/api/v1/analytics/users/:userId/activity', (_req, res) => res.status(204).end());
