...
export declare const getPostReactions: (req: Request, res: Response) => Promise<void>;
...
export declare const bookmarkPost: (req: Request, res: Response) => Promise<void>;
export declare const getBookmarkedPosts: (req: Request, res: Response) => Promise<void>;
