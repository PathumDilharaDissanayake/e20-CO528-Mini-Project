...
export const logger = winston.createLogger({
  ...
  transports: [
    ...
    new winston.transports.File({ filename: 'logs/events-error.log', level: 'error', format: logFormat }),
    new winston.transports.File({ filename: 'logs/events-combined.log', format: logFormat })
  ]
});
