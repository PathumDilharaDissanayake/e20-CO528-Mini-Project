...
Write-Host ""
Write-Host "=== DECP Platform - Terraform Backend Bootstrap ===" -ForegroundColor Cyan

# -- S3 Bucket --
Write-Host ""
Write-Host "[1/4] Creating S3 bucket: $BucketName ..." -ForegroundColor Green
...
# -- Summary --
Write-Host ""
Write-Host "[4/4] Backend bootstrap complete!" -ForegroundColor Cyan
